...
from src.operations import is_integer, is_user_command_valid, parse_cli_input
...
def test_is_command_valid_raises_error():
    ...
    expected_result = (
        f"Invalid command. User entered GO!. Acceptable commands are {commands_str}."
    )
